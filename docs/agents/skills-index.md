...
| `blender-bpy` | `docs/skills/blender-bpy.md` | `.claude/skills/blender-bpy/SKILL.md` | `.kilo/command/blender-bpy.md` | Modelado 3D programatico con Blender (bpy) headless: render preview + GLB. |
