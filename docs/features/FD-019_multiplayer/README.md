...
## Estado
- Requiere reimplementación tras el refactor core_v2.
...
## Próximos pasos
- Integrar múltiples `InputProviderV2` con `device_id`.
...
- Escribir tests en `core_v2/tests` para validar interacción multi-jugador.
