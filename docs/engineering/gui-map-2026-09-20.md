...
>
> **Vigencia.** Este mapa es material de trabajo, no la especificación. La spec de la
> interfaz va a ser `docs/odiseaos/MANUAL_DEL_TRIPULANTE.md` (en redacción), escrito en
> voz de a bordo; cuando exista, este documento pasa a ser su apéndice técnico.
