# core/systems/OYS_Interpreter.gd
...
const OYS_Parser = preload("res://core/systems/OYS_Parser.gd")
	...
	match cmd:
		...
		"RECORD_START":
			...
			if recorder:
				...
				var FrameRecorder = load("res://core/systems/FrameRecorder.gd")
...
func _resolve_value(val):
	...
	if val == "yaw_deg" or val == "pitch_deg":
		...
		# Priority 1: Direct property (synced in PlayerController)
		if val in player:
