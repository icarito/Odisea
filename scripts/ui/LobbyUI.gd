...
onready var join_ip_button = $VBoxContainer/HBoxContainer/JoinIPButton
onready var ip_line_edit = $VBoxContainer/HBoxContainer/IPLineEdit
onready var server_list = $VBoxContainer/ServerList
onready var join_server_button = $VBoxContainer/JoinServerButton
