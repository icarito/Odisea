...
GA_EVAL_EPISODES="${GA_EVAL_EPISODES:-8}"
...
GA_STAGE4_TIMESTEPS="${GA_STAGE4_TIMESTEPS:-18000}"
GA_STAGE5_TIMESTEPS="${GA_STAGE5_TIMESTEPS:-18000}"
...
GA_SUCCESS_TARGET="${GA_SUCCESS_TARGET:-0.45}"
GA_DIRECTION_TARGET="${GA_DIRECTION_TARGET:-0.70}"
GA_FAST_SUCCESS_TARGET="${GA_FAST_SUCCESS_TARGET:-0.35}"
GA_TRAIN_PHYSICS_FPS="${GA_TRAIN_PHYSICS_FPS:-2000}"
GA_EVAL_PHYSICS_FPS="${GA_EVAL_PHYSICS_FPS:-60}"
GA_NUM_ENVS="${GA_NUM_ENVS:-1}"
GA_PARALLEL_JOBS="${GA_PARALLEL_JOBS:-1}"
GA_WORKERS="${GA_WORKERS:-1}"
