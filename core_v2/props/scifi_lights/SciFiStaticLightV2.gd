tool
extends PropBaseV2
class_name SciFiStaticLightV2

# SciFiStaticLightV2.gd - A simple static capsule light prop.
# Extends PropBaseV2 so it follows the interactable contract (on/off).
