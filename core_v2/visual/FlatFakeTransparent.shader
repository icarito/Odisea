shader_type spatial;
// Variante TRANSPARENTE de FlatFake para el perfil low-end: el vidrio (criopods,
// ventanas) conserva su transparencia en vez de quedar como un panel opaco. Mismo
// shading falso (headlight + AO vertical, sin luces ni PBR), con blend_mix y ALPHA.
// depth_draw_opaque: no escribe profundidad en pixeles translucidos, asi que lo que
// esta detras se ve a traves del vidrio.
render_mode unshaded, cull_back, blend_mix, depth_draw_opaque, specular_disabled;
