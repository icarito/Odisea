...
static func _instruction_to_frames(inst: Dictionary, start_frame: int) -> Dictionary:
	...
	match cmd:
		...
		"ASSERT", "SET", "MATH", "PRINT", "CLS", "GET_NODES_IN_GROUP", "CALL", "LOAD_PROP", "SPAWN", "PLAY_ANIM", "PLAY_SOUND", "SET_TIME_SCALE", "CINEMATIC_START", "CINEMATIC_STOP", "CAMERA_SHAKE", "CAMERA_SHAKE_STOP", "OPEN", "CHANGE_SCENE", "ANNA_ENABLE", "ANNA_DISABLE", "ANNA_SET_TARGET":
		...
		"PLAY_ANIM", "WAIT_ANIM", "SPAWN", "SET_TIME_SCALE", "SCREENSHOT", "ANNA_ENABLE", "ANNA_DISABLE", "ANNA_SET_TARGET", \
