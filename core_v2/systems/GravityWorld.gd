...
func get_canonical_gravity_direction(canonical_position: Vector3) -> Vector3:
	return _get_canonical_gravity_direction_for_mode(canonical_position, _current_mode, true)

func get_canonical_gravity_direction_for_mode(canonical_position: Vector3, mode: int) -> Vector3:
	return _get_canonical_gravity_direction_for_mode(canonical_position, mode, true)
...
func get_gravity_strength(canonical_position: Vector3) -> float:
	return _get_gravity_strength_for_mode(canonical_position, _current_mode, true)

func get_gravity_strength_for_mode(canonical_position: Vector3, mode: int) -> float:
	return _get_gravity_strength_for_mode(canonical_position, mode, true)
...
func get_canonical_gravity_for_mode(canonical_position: Vector3, mode: int) -> Vector3:
	return _get_canonical_gravity_direction_for_mode(canonical_position, mode, true) \
			* _get_gravity_strength_for_mode(canonical_position, mode, true)
...
func get_physical_gravity(global_position: Vector3) -> Vector3:
	...
	var canonical_gravity: Vector3 = _get_canonical_gravity_direction_for_mode(canonical_position, mode, include_blend) \
			* _get_gravity_strength_for_mode(canonical_position, mode, include_blend)
	if _rotator:
